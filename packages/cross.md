...
```console
xrepo install -p cross [--sdk=/xxx] faad2
```
...
```console
xrepo install -p cross [--sdk=/xxx] lrdf
```
...
```console
xrepo install -p cross [--sdk=/xxx] nam-core
```
...
```console
xrepo install -p cross [--sdk=/xxx] raptor2
```
...
```console
xrepo install -p cross [--sdk=/xxx] xrefl
```

...
```console
xrepo install -p mingw [--mingw=/xxx] alpaka
```
...
| License | BSD-3-Clause |
| Versions | 24.09, 24.12, 25.02, 25.03, 25.04, 25.05, 25.06, 25.08, 25.09, 25.11, 26.01, 26.02, 26.03, 26.05, 26.08, 26.09 |
| Architectures | arm, arm64, i386, x86_64 |
...
| License | Apache-2.0 |
| Versions | v0.12.1, v0.13.1, v0.14.1, v0.15.0, v0.16.0 |
| Architectures | arm, arm64, i386, x86_64 |
...
```console
xrepo install -p mingw [--mingw=/xxx] approval-tests-cpp
```
...
| License | BSD-3-Clause |
| Versions | v5.0.1, v5.1.4, v5.2.1, v5.2.2, v5.2.3, v5.2.4, v5.2.5, v5.3.0, v5.3.1, v5.4.0, v5.4.1, v5.4.2, v5.4.3, v6.0.1, v6.0.2, v6.0.3, v6.0.4, v6.0.5 |
| Architectures | arm, arm64, i386, x86_64 |
...
| License | MIT |
| Versions | v1.5, v1.6.3, v1.6.4, v1.6.5, v1.6.9, v1.7.1, v1.9.1, v1.9.2 |
| Architectures | arm, arm64, i386, x86_64 |
...
```console
xrepo install -p mingw [--mingw=/xxx] awk
```
...
```console
xrepo install -p mingw [--mingw=/xxx] bc_crunch
```
...
```console
xrepo install -p mingw [--mingw=/xxx] beaengine
```
...
```console
xrepo install -p mingw [--mingw=/xxx] bestsource
```
...
| License | BSL-1.0 |
| Versions | 1.70.0, 1.72.0, 1.73.0, 1.74.0, 1.75.0, 1.76.0, 1.77.0, 1.78.0, 1.79.0, 1.80.0, 1.81.0, 1.82.0, 1.83.0, 1.84.0, 1.85.0, 1.86.0, 1.87.0, 1.88.0, 1.89.0, 1.90.0, 1.91.0-1, 1.92.0 |
| Architectures | arm, arm64, i386, x86_64 |
...
```console
xrepo install -p mingw [--mingw=/xxx] boost_assert
```
...
```console
xrepo install -p mingw [--mingw=/xxx] boost_config
```
...
```console
xrepo install -p mingw [--mingw=/xxx] boost_math
```
...
```console
xrepo install -p mingw [--mingw=/xxx] boost_static_assert
```
...
```console
xrepo install -p mingw [--mingw=/xxx] boost_throw_exception
```
...
```console
xrepo install -p mingw [--mingw=/xxx] boost_type_traits
```
...
```console
xrepo install -p mingw [--mingw=/xxx] boost_uuid
```
...
```console
xrepo install -p mingw [--mingw=/xxx] box3d
```
...
```console
xrepo install -p mingw [--mingw=/xxx] byte-lite
```
...
| License | MIT |
| Versions | 1.16.1, 1.17.0, 1.17.1, 1.17.2, 1.18.0, 1.18.1, 1.19.0, 1.27.0, 1.28.1, 1.29.0, 1.30.0, 1.31.0, 1.32.2, 1.32.3, 1.33.0, 1.33.1, 1.34.1, 1.34.3, 1.34.4, 1.34.5, 1.34.6, 1.34.8 |
| Architectures | arm, arm64, i386, x86_64 |
...
```console
xrepo install -p mingw [--mingw=/xxx] cairo
```
...
```console
xrepo install -p mingw [--mingw=/xxx] cairomm
```
...
| License | CeCILL-C |
| Versions | v3.4.0, v3.4.1, v3.4.2, v3.4.3, v3.5.0, v3.5.1, v3.5.2, v3.5.3, v3.5.4, v3.5.5, v3.6.0, v3.6.1, v3.6.2, v3.6.3, v3.6.4, v3.6.5, v3.6.6, v3.7.0, v3.7.4, v3.7.5, v4.0.4 |
| Architectures | arm, arm64, i386, x86_64 |
...
| License | BSD |
| Versions | v2.2.0, v2.3.2, v2.4.1, v2.4.2, v2.5.0, v2.6.1, v2.6.2, v2.7.2 |
| Architectures | arm, arm64, i386, x86_64 |
...
```console
xrepo install -p mingw [--mingw=/xxx] clip
```
...
```console
xrepo install -p mingw [--mingw=/xxx] coal
```
...
```console
xrepo install -p mingw [--mingw=/xxx] cpp-subprocess
```
...
```console
xrepo install -p mingw [--mingw=/xxx] cppad
```
...
```console
xrepo install -p mingw [--mingw=/xxx] cppli
```
...
| License | Apache-2.0 |
| Versions | v0.6.0, v0.7.0, v0.9.0, v0.10.0, v0.10.1, v0.11.0 |
| Architectures | arm, arm64, i386, x86_64 |
...
```console
xrepo install -p mingw [--mingw=/xxx] crashcatch
```
...
```console
xrepo install -p mingw [--mingw=/xxx] darts
```
...
```console
xrepo install -p mingw [--mingw=/xxx] dascript
```
...
| License | BSL-1.0 |
| Versions | v2.96.1, v2.102.0, v2.106.0, v2.106.1, v2.110.0, v2.114.0, v2.114.1, v2.118.0, v2.123.2, v2.131.0, v2.132.1, v2.132.2, v2.135.0 |
| Architectures | arm, arm64, i386, x86_64 |
...
```console
xrepo install -p mingw [--mingw=/xxx] dbus
```
...
| Homepage | [https://github.com/mackron/dr_libs](https://github.com/mackron/dr_libs) |
| License | MIT |
| Versions | 0.12.19, 0.13.8, 0.13.10, 0.13.11, 0.13.12, 0.13.13, 0.13.16, 0.13.17, 0.14.1, 0.14.2, 0.14.3, 0.14.4, 0.14.5 |
| Architectures | arm, arm64, i386, x86_64 |
...
```console
xrepo install -p mingw [--mingw=/xxx] eastl
```
...
| License | MIT |
| Versions | 1.1.0, 1.2.0, 1.3.0, 1.3.1, 1.4.0, 1.4.1, 1.5.0, 1.5.1, 1.6.2, 1.6.3, 1.7.2 |
| Architectures | arm, arm64, i386, x86_64 |
...
```console
xrepo install -p mingw [--mingw=/xxx] embedded-xoodyak
```
...
```console
xrepo install -p mingw [--mingw=/xxx] emock
```
...
| License | MIT |
| Versions | v3.6.0, v3.7.0, v3.7.1, v3.8.0, v3.8.1, v3.9.0, v3.10.0, v3.10.1, v3.10.3, v3.11.0, v3.11.1, v3.12.1, v3.12.2, v3.13.0, v3.13.1, v3.13.2, v3.14.0, v3.15.0, v3.16.0, v4.0.0 |
| Architectures | arm, arm64, i386, x86_64 |
...
```console
xrepo install -p mingw [--mingw=/xxx] esp32-arduino-libs
```
...
```console
xrepo install -p mingw [--mingw=/xxx] esp32-devel
```
...
```console
xrepo install -p mingw [--mingw=/xxx] esptool
```
...
```console
xrepo install -p mingw [--mingw=/xxx] eui-neo
```
...
```console
xrepo install -p mingw [--mingw=/xxx] faad2
```
...
```console
xrepo install -p mingw [--mingw=/xxx] fadec
```
...
```console
xrepo install -p mingw [--mingw=/xxx] fcgi
```
...
```console
xrepo install -p mingw [--mingw=/xxx] filc
```
...
| License | MIT |
| Versions | v2.4.8, v3.0.0, v3.2.4, v3.2.5, v3.2.6, v3.2.7, v3.2.8, v3.2.9, v3.2.10, v3.2.11, v3.2.12, v4.0.0, v4.0.1, v4.0.2, v4.0.3, v4.0.4, v4.0.5, v4.1.0, v4.1.1, v4.1.2, v4.1.4, v4.1.5, v4.1.6 |
| Architectures | arm, arm64, i386, x86_64 |
...
```console
xrepo install -p mingw [--mingw=/xxx] fontconfig
```
...
| License | Apache-2.0 |
| Versions | 3.15.0, 3.16.0, 3.17.2, 3.18.0, 3.19.1, 3.20.0, 3.21.0, 3.22.0, 3.23.0, 3.24.0, 3.25.0, 3.26.0, 3.27.1, 3.29.0, 3.30.0 |
| Architectures | arm, arm64, i386, x86_64 |
...
```console
xrepo install -p mingw [--mingw=/xxx] freexl
```
...
| License | MIT |
| Versions | v0.15.29, v0.15.31, v0.16.0, v0.16.2, v0.17.1, v0.18.2, v0.20.0 |
| Architectures | arm, arm64, i386, x86_64 |
...
| License | MIT |
| Versions | v3.0.0, v4.1.1, v5.0.0, v6.0.2, v6.1.1, v6.1.9, v7.0.0, v7.0.1, v7.0.3 |
| Architectures | arm, arm64, i386, x86_64 |
...
```console
xrepo install -p mingw [--mingw=/xxx] fxdiv
```
...
```console
xrepo install -p mingw [--mingw=/xxx] geo-utils-cpp
```
...
```console
xrepo install -p mingw [--mingw=/xxx] geode-sdk-result
```
...
```console
xrepo install -p mingw [--mingw=/xxx] geode-sdk-tuliphook
```
...
```console
xrepo install -p mingw [--mingw=/xxx] geos
```
...
```console
xrepo install -p mingw [--mingw=/xxx] glibmm
```
...
```console
xrepo install -p mingw [--mingw=/xxx] glslang-nihui
```
...
```console
xrepo install -p mingw [--mingw=/xxx] gtl
```
...
```console
xrepo install -p mingw [--mingw=/xxx] gz-cmake
```
...
```console
xrepo install -p mingw [--mingw=/xxx] gz-utils
```
...
```console
xrepo install -p mingw [--mingw=/xxx] hashcat
```
...
```console
xrepo install -p mingw [--mingw=/xxx] jrl-cmakemodules
```
...
| License | BSL-1.0 |
| Versions | v0.170.2, v0.176.0, v0.177.0, v0.178.0, v1.0.0, v1.1.0, v1.2.0, v1.3.0, v1.3.2, v1.4.3, v1.5.0, v1.8.1 |
| Architectures | arm, arm64, i386, x86_64 |
...
```console
xrepo install -p mingw [--mingw=/xxx] kenlm
```
...
```console
xrepo install -p mingw [--mingw=/xxx] ldtkloader
```
...
```console
xrepo install -p mingw [--mingw=/xxx] libdispatch
```
...
| License | Apache-2.0 |
| Versions | v1.1.0, v1.4.0, v1.4.1, v1.4.2, v1.4.3, v1.4.4, v1.5.1, v1.5.2, v1.5.3 |
| Architectures | arm, arm64, i386, x86_64 |
...
```console
xrepo install -p mingw [--mingw=/xxx] libepoxy
```
...
| Versions | v1.3.0, v1.7.1, v1.8.0, v1.8.1, v1.8.2, v1.8.4, v1.9.0, v1.9.1, v1.9.2, v1.9.3, v1.9.4, v1.9.6, v1.9.7 |
| Architectures | arm, arm64, i386, x86_64 |
...
```console
xrepo install -p mingw [--mingw=/xxx] liblo
```
...
```console
xrepo install -p mingw [--mingw=/xxx] libnfc
```
...
```console
xrepo install -p mingw [--mingw=/xxx] libopenmpt
```
...
```console
xrepo install -p mingw [--mingw=/xxx] libp2p
```
...
| License | MIT |
| Versions | 0.1.5, 0.2.1, 0.3.0, 0.3.1, 0.4.0, 0.5.4, 0.8.0, 1.0.2 |
| Architectures | arm, arm64, i386, x86_64 |
...
```console
xrepo install -p mingw [--mingw=/xxx] librats
```
...
| License | BSD-2-Clause |
| Versions | v1.6.2, v1.8.2-POST2, v2.11.0, v2.11.1, v2.12.1, v2.13.0, v2.13.2, v2.14.0, v2.14.2, v2.15.1 |
| Architectures | arm, arm64, i386, x86_64 |
...
```console
xrepo install -p mingw [--mingw=/xxx] librealsense
```
...
```console
xrepo install -p mingw [--mingw=/xxx] librime
```
...
```console
xrepo install -p mingw [--mingw=/xxx] librttopo
```
...
| License | BSD-3-Clause |
| Versions | 0.7.34, 0.7.35, 0.7.36, 0.7.37, 0.7.39 |
| Architectures | arm, arm64, i386, x86_64 |
...
```console
xrepo install -p mingw [--mingw=/xxx] libsolv
```
...
```console
xrepo install -p mingw [--mingw=/xxx] libusb-compat
```
...
```console
xrepo install -p mingw [--mingw=/xxx] libusb-win32
```
...
| License | LGPL-2.1 |
| Versions | v8.15.1, v8.15.2, v8.15.3, v8.15.4, v8.15.5, v8.16.0, v8.16.1, v8.17.1, v8.17.2, v8.17.3, v8.18.0, v8.18.1, v8.18.2, v8.18.3, v8.18.5, v8.18.6 |
| Architectures | arm, arm64, i386, x86_64 |
...
```console
xrepo install -p mingw [--mingw=/xxx] libxcrypt
```
...
```console
xrepo install -p mingw [--mingw=/xxx] libxls
```
...
```console
xrepo install -p mingw [--mingw=/xxx] llgl
```
...
| License | MIT |
| Versions | v3.0.0, v8.1.0, v9.2.1, v9.3.0, v9.3.1, v9.4.1, v9.4.2, v9.4.3 |
| Architectures | arm, arm64, i386, x86_64 |
...
```console
xrepo install -p mingw [--mingw=/xxx] lv2
```
...
| License | MIT |
| Versions | v0.7.3, v0.8.0, v0.8.1, v0.8.2, v0.9.0, v0.9.5, v0.9.6, v0.9.7, v0.9.8 |
| Architectures | arm, arm64, i386, x86_64 |
...
| License | Apache-2.0 |
| Versions | v3.2.1, v3.3.2, v3.5.0, v3.5.1, v3.5.2, v3.5.3 |
| Architectures | arm, arm64, i386, x86_64 |
...
```console
xrepo install -p mingw [--mingw=/xxx] manifold
```
...
```console
xrepo install -p mingw [--mingw=/xxx] marl
```
...
```console
xrepo install -p mingw [--mingw=/xxx] matplotplusplus
```
...
```console
xrepo install -p mingw [--mingw=/xxx] mdspan
```
...
| License | MIT |
| Versions | v0.18, v0.20, v0.21, v0.22, v0.23, v0.24, v0.25, v1.0, v1.0.1, v1.1.1, v1.2 |
| Architectures | arm, arm64, i386, x86_64 |
...
```console
xrepo install -p mingw [--mingw=/xxx] meshoptimizer
```
...
```console
xrepo install -p mingw [--mingw=/xxx] microstl
```
...
```console
xrepo install -p mingw [--mingw=/xxx] mpg123
```
...
```console
xrepo install -p mingw [--mingw=/xxx] mplib
```
...
```console
xrepo install -p mingw [--mingw=/xxx] mquickjs
```
...
```console
xrepo install -p mingw [--mingw=/xxx] nam-core
```
...
### nativefiledialog-extended (mingw)
...
```console
xrepo install -p mingw [--mingw=/xxx] nativefiledialog-extended
```
...
| License | BSD-3-Clause |
| Versions | 20250503, 20250916, 20260113, 20260526 |
| Architectures | arm, arm64, i386, x86_64 |
...
```console
xrepo install -p mingw [--mingw=/xxx] ng-log
```
...
| License | MIT |
| Versions | 1.46.0, 1.58.0, 1.59.0, 1.60.0, 1.61.0, 1.62.0, 1.62.1, 1.63.0, 1.64.0, 1.65.0, 1.66.0, 1.67.0, 1.67.1, 1.68.0, 1.68.1, 1.69.0, 1.70.0 |
| Architectures | arm, arm64, i386, x86_64 |
...
| License | MIT |
| Versions | v8.0.0, v8.2.2, v8.3.0, v8.3.1, v8.4.0, v8.5.0, v8.6.0, v8.7.0, v8.8.0, v8.9.0, v8.9.2 |
| Architectures | arm, arm64, i386, x86_64 |
...
```console
xrepo install -p mingw [--mingw=/xxx] node_crunch2
```
...
```console
xrepo install -p mingw [--mingw=/xxx] nv-codec-headers
```
...
```console
xrepo install -p mingw [--mingw=/xxx] observer-ptr-lite
```
...
```console
xrepo install -p mingw [--mingw=/xxx] ompl
```
...
```console
xrepo install -p mingw [--mingw=/xxx] oneshot
```
...
```console
xrepo install -p mingw [--mingw=/xxx] openai-cpp
```
...
```console
xrepo install -p mingw [--mingw=/xxx] opencc
```
...
| License | BSD-3-Clause |
| Versions | v2.5.3, v2.5.5, v2.5.7, v3.1.0, v3.1.1, v3.1.3, v3.1.4, v3.1.5, v3.2.1, v3.2.3, v3.2.4, v3.3.0, v3.3.1, v3.3.2, v3.3.3, v3.3.4, v3.3.5, v3.4.0, v3.4.4, v3.4.5, v3.4.6, v3.4.7, v3.4.9, v3.4.10, v3.4.11, v3.4.12, v3.4.13, v3.4.14 |
| Architectures | arm, arm64, i386, x86_64 |
...
```console
xrepo install -p mingw [--mingw=/xxx] openimagedenoise
```
...
```console
xrepo install -p mingw [--mingw=/xxx] openjph
```
...
```console
xrepo install -p mingw [--mingw=/xxx] openssh
```
...
| Homepage | [https://www.openssl.org/](https://www.openssl.org/) |
| License | Apache-2.0 |
| Versions | 3.0.0, 3.0.1, 3.0.2, 3.0.3, 3.0.4, 3.0.5, 3.0.6, 3.0.7, 3.0.14, 3.0.17, 3.0.19, 3.0.20, 3.0.21, 3.1.8, 3.2.5, 3.2.6, 3.3.1, 3.3.2, 3.3.4, 3.3.6, 3.3.7, 3.4.2, 3.4.4, 3.4.5, 3.4.6, 3.5.1, 3.5.4, 3.5.5, 3.5.6, 3.5.7, 3.6.0, 3.6.1, 3.6.2, 3.6.3 |
| Architectures | arm, arm64, i386, x86_64 |
...
```console
xrepo install -p mingw [--mingw=/xxx] pango
```
...
```console
xrepo install -p mingw [--mingw=/xxx] par
```
...
| License | MIT |
| Versions | 6.3.1, 8.2.1, 9.0.1, 9.4.0, 9.6.1, 9.7.0, 9.7.1, 9.8.0, 9.8.1 |
| Architectures | arm, arm64, i386, x86_64 |
...
| License | MIT |
| Versions | v0.5.0, v0.6.1, v0.7.0, v0.8.0, v0.9.0, v0.11.0, v0.12.1, v0.13.0, v0.14.0, v0.15.0, v0.15.1 |
| Architectures | arm, arm64, i386, x86_64 |
...
```console
xrepo install -p mingw [--mingw=/xxx] ragel
```
...
| License | zlib |
| Versions | v5.0.1, v5.0.2, v5.5.0, v5.5.1, v6.0.0, v6.0.1, v6.0.2, v6.0.3 |
| Architectures | arm, arm64, i386, x86_64 |
...
```console
xrepo install -p mingw [--mingw=/xxx] rgfw
```
...
```console
xrepo install -p mingw [--mingw=/xxx] riscv32-esp-elf
```
...
```console
xrepo install -p mingw [--mingw=/xxx] rtm
```
...
```console
xrepo install -p mingw [--mingw=/xxx] rubberband
```
...
```console
xrepo install -p mingw [--mingw=/xxx] sdformat
```
...
```console
xrepo install -p mingw [--mingw=/xxx] serd
```
...
```console
xrepo install -p mingw [--mingw=/xxx] sha2
```
...
```console
xrepo install -p mingw [--mingw=/xxx] sigslot
```
...
```console
xrepo install -p mingw [--mingw=/xxx] simple_http
```
...
| License | OBSD |
| Versions | 1.5.1, 1.5.2, 1.6.1, 1.6.3, 1.6.4, 1.6.5, 1.7.0 |
| Architectures | arm, arm64, i386, x86_64 |
...
```console
xrepo install -p mingw [--mingw=/xxx] simplecpp
```
...
```console
xrepo install -p mingw [--mingw=/xxx] sjpeg
```
...
```console
xrepo install -p mingw [--mingw=/xxx] sleef
```
...
```console
xrepo install -p mingw [--mingw=/xxx] slikenet
```
...
```console
xrepo install -p mingw [--mingw=/xxx] sord
```
...
| License | Public Domain |
| Versions | 3.23.0+0, 3.24.0+0, 3.34.0+100, 3.35.0+300, 3.35.0+400, 3.36.0+0, 3.37.0+200, 3.39.0+200, 3.43.0+200, 3.45.0+300, 3.45.0+100, 3.45.0+200, 3.46.0+0, 3.46.0+100, 3.47.0+200, 3.47.0+0, 3.47.0+100, 3.48.0+0, 3.49.0+0, 3.49.0+100, 3.49.0+200, 3.50.0+0, 3.50.0+100, 3.50.0+200, 3.50.0+300, 3.50.0+400, 3.51.0+0, 3.51.0+100, 3.51.0+200, 3.51.0+300, 3.53.0+200, 3.53.0+0, 3.53.0+100, 3.53.0+400 |
| Architectures | arm, arm64, i386, x86_64 |
...
| Description | *A complete standardlib for c for once* |
| -- | -- |
...
```console
xrepo install -p mingw [--mingw=/xxx] status-code
```
...
```console
xrepo install -p mingw [--mingw=/xxx] stv
```
...
```console
xrepo install -p mingw [--mingw=/xxx] tomlc17
```
...
```console
xrepo install -p mingw [--mingw=/xxx] trianglemeshdistance
```
...
```console
xrepo install -p mingw [--mingw=/xxx] tvision
```
...
```console
xrepo install -p mingw [--mingw=/xxx] udis86
```
...
| License | MIT |
| Versions | v0.6.1, v0.11.1, v0.12.0, v0.13.0, v0.14.0, v0.14.2, v0.14.3, v0.15.0, v0.15.1, v0.18.2, v0.20.0, v0.20.1, v0.21.2, v0.21.3, v0.22.0, v0.23.0 |
| Architectures | arm, arm64, i386, x86_64 |
...
| License | BSD-2-Clause |
| Versions | v1.0.0, v1.0.1, v1.0.2, v1.2.0, v2.0.0, v2.1.0, v2.2.0, v2.3.0, v2.4.0, v2.5.0 |
| Architectures | arm, arm64, i386, x86_64 |
...
```console
xrepo install -p mingw [--mingw=/xxx] valijson
```
...
```console
xrepo install -p mingw [--mingw=/xxx] vamp-plugin-sdk
```
...
```console
xrepo install -p mingw [--mingw=/xxx] vapoursynth
```
...
| License | LGPL-3.0 |
| Versions | v5.016, v5.032, v5.034, v5.036, v5.038, v5.042, v5.044, v5.046, v5.048, v5.050, v5.052 |
| Architectures | arm, arm64, i386, x86_64 |
...
| -- | -- |
| Homepage | [https://github.com/JustasMasiulis/xorstr](https://github.com/JustasMasiulis/xorstr) |
| License | Apache-2.0 |
| Versions | 2021.11.19 |
| Architectures | arm, arm64, x86_64 |
| Definition | [xorstr/xmake.lua](https://github.com/xmake-io/xmake-repo/blob/master/packages/x/xorstr/xmake.lua) |
...
```console
xrepo install -p mingw [--mingw=/xxx] xrefl
```
...
```console
xrepo install -p mingw [--mingw=/xxx] xtensa-esp-elf
```
...
```console
xrepo install -p mingw [--mingw=/xxx] xxmlxx
```
...
```console
xrepo install -p mingw [--mingw=/xxx] xz-embedded
```
...
```console
xrepo install -p mingw [--mingw=/xxx] yojimbo
```
...
```console
xrepo install -p mingw [--mingw=/xxx] zix
```
...
```console
xrepo install -p mingw [--mingw=/xxx] zziplib
```

...
```console
xrepo install -p android [--ndk=/xxx] faad2
```
...
```console
xrepo install -p android [--ndk=/xxx] lrdf
```
...
```console
xrepo install -p android [--ndk=/xxx] nam-core
```
...
```console
xrepo install -p android [--ndk=/xxx] raptor2
```
...
```console
xrepo install -p android [--ndk=/xxx] xrefl
```
...
```console
xrepo install -p android [--ndk=/xxx] zmij
```

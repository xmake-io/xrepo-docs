...
```console
xrepo install -p iphoneos alpaka
```
...
```console
xrepo install -p iphoneos appimage
```
...
```console
xrepo install -p iphoneos base64-zhicheng
```
...
```console
xrepo install -p iphoneos bc_crunch
```
...
```console
xrepo install -p iphoneos beaengine
```
...
```console
xrepo install -p iphoneos boost_assert
```
...
```console
xrepo install -p iphoneos boost_config
```
...
```console
xrepo install -p iphoneos boost_math
```
...
```console
xrepo install -p iphoneos boost_static_assert
```
...
### boost_throw_exception (iphoneos)
...
```console
xrepo install -p iphoneos boost_throw_exception
```
...
```console
xrepo install -p iphoneos boost_type_traits
```
...
```console
xrepo install -p iphoneos boost_uuid
```
...
```console
xrepo install -p iphoneos boringssl
```
...
```console
xrepo install -p iphoneos box3d
```
...
```console
xrepo install -p iphoneos byte-lite
```
...
```console
xrepo install -p iphoneos cairo
```
...
```console
xrepo install -p iphoneos cairomm
```
...
```console
xrepo install -p iphoneos cli11
```
...
```console
xrepo install -p iphoneos cppli
```
...
```console
xrepo install -p iphoneos crashcatch
```
...
```console
xrepo install -p iphoneos darts
```
...
```console
xrepo install -p iphoneos dascript
```
...
```console
xrepo install -p iphoneos embedded-xoodyak
```
...
```console
xrepo install -p iphoneos esp32-arduino-libs
```
...
```console
xrepo install -p iphoneos esp32-devel
```
...
```console
xrepo install -p iphoneos esptool
```
...
```console
xrepo install -p iphoneos faad2
```
...
```console
xrepo install -p iphoneos fadec
```
...
```console
xrepo install -p iphoneos fontconfig
```
...
```console
xrepo install -p iphoneos freexl
```
...
```console
xrepo install -p iphoneos fribidi
```
...
```console
xrepo install -p iphoneos fxdiv
```
...
```console
xrepo install -p iphoneos geo-utils-cpp
```
...
```console
xrepo install -p iphoneos glslang-nihui
```
...
```console
xrepo install -p iphoneos gz-math
```
...
```console
xrepo install -p iphoneos hiredis-vip
```
...
| License | MIT |
| Versions | 3.1, 3.2.3, 3.4, 3.5, 3.5.1, 3.5.3, 3.6, 3.7, 3.8, 3.9 |
| Architectures | arm64, x86_64 |
...
```console
xrepo install -p iphoneos hyperscan
```
...
```console
xrepo install -p iphoneos incbin
```
...
```console
xrepo install -p iphoneos jrl-cmakemodules
```
...
| Description | *This library aims for runtime code patching for both Android and iOS* |
| -- | -- |
| Homepage | [https://github.com/MJx0/KittyMemory](https://github.com/MJx0/KittyMemory) |
| License | MIT |
| Versions | 2025.05.30 |
| Architectures | arm64, x86_64 |
| Definition | [kittymemory/xmake.lua](https://github.com/xmake-io/xmake-repo/blob/master/packages/k/kittymemory/xmake.lua) |
...
```console
xrepo install -p iphoneos libccd
```
...
```console
xrepo install -p iphoneos libdatachannel
```
...
```console
xrepo install -p iphoneos libeconf
```
...
```console
xrepo install -p iphoneos libepoxy
```
...
```console
xrepo install -p iphoneos libopenmpt
```
...
```console
xrepo install -p iphoneos libp2p
```
...
```console
xrepo install -p iphoneos librealsense
```
...
```console
xrepo install -p iphoneos librime
```
...
```console
xrepo install -p iphoneos libsdl2_mixer_x
```
...
```console
xrepo install -p iphoneos libsdl3_mixer
```
...
```console
xrepo install -p iphoneos libsolv
```
...
```console
xrepo install -p iphoneos libxls
```
...
```console
xrepo install -p iphoneos libzchunk
```
...
```console
xrepo install -p iphoneos lsquic
```
...
```console
xrepo install -p iphoneos manifold
```
...
```console
xrepo install -p iphoneos marchingcubecpp
```
...
```console
xrepo install -p iphoneos mdspan
```
...
```console
xrepo install -p iphoneos meshoptimizer
```
...
| -- | -- |
| Homepage | [https://developer.apple.com/metal/cpp/](https://developer.apple.com/metal/cpp/) |
| License | Apache-2.0 |
| Versions | 12, 13, 13.3, 14.2, 15, 15.2, 26 |
| Architectures | arm64, x86_64 |
| Definition | [metal-cpp/xmake.lua](https://github.com/xmake-io/xmake-repo/blob/master/packages/m/metal-cpp/xmake.lua) |

##### Install command

```console
xrepo install -p iphoneos metal-cpp
```
...
| License | Apache-2.0 |
| Versions | v1.1.0, v1.1.4, v1.1.5, v1.2.0, v1.2.7, v1.2.8, v1.2.9, v1.2.10, v1.2.11, v1.3.0, v1.4.0, v1.4.1, v1.4.2 |
| Architectures | arm64, x86_64 |
...
```console
xrepo install -p iphoneos mplib
```
...
```console
xrepo install -p iphoneos mquickjs
```
...
```console
xrepo install -p iphoneos mujoco
```
...
```console
xrepo install -p iphoneos ng-log
```
...
```console
xrepo install -p iphoneos node_crunch2
```
...
```console
xrepo install -p iphoneos nowide_standalone
```
...
```console
xrepo install -p iphoneos observer-ptr-lite
```
...
```console
xrepo install -p iphoneos oneshot
```
...
```console
xrepo install -p iphoneos openai-cpp
```
...
```console
xrepo install -p iphoneos openblas
```
...
```console
xrepo install -p iphoneos opencc
```
...
```console
xrepo install -p iphoneos openimagedenoise
```
...
```console
xrepo install -p iphoneos openjph
```
...
```console
xrepo install -p iphoneos openssh
```
...
```console
xrepo install -p iphoneos pinocchio
```
...
```console
xrepo install -p iphoneos qpoases
```
...
```console
xrepo install -p iphoneos ragel
```
...
```console
xrepo install -p iphoneos riscv32-esp-elf
```
...
```console
xrepo install -p iphoneos rubberband
```
...
```console
xrepo install -p iphoneos sdformat
```
...
```console
xrepo install -p iphoneos sigslot
```
...
```console
xrepo install -p iphoneos simplecpp
```
...
```console
xrepo install -p iphoneos sjpeg
```
...
```console
xrepo install -p iphoneos sleef
```
...
```console
xrepo install -p iphoneos slikenet
```
...
```console
xrepo install -p iphoneos spectra
```
...
| License | Public Domain |
| Versions | 3.23.0+0, 3.24.0+0, 3.34.0+100, 3.35.0+400, 3.35.0+300, 3.36.0+0, 3.37.0+200, 3.39.0+200, 3.43.0+200, 3.45.0+300, 3.45.0+100, 3.45.0+200, 3.46.0+100, 3.46.0+0, 3.47.0+200, 3.47.0+0, 3.47.0+100, 3.48.0+0, 3.49.0+200, 3.49.0+100, 3.49.0+0, 3.50.0+400, 3.50.0+300, 3.50.0+200, 3.50.0+100, 3.50.0+0, 3.51.0+200, 3.51.0+300, 3.51.0+100, 3.51.0+0, 3.53.0+200, 3.53.0+0, 3.53.0+100, 3.53.0+400 |
| Architectures | arm64, x86_64 |
...
```console
xrepo install -p iphoneos status-code
```
...
```console
xrepo install -p iphoneos tomlc17
```
...
```console
xrepo install -p iphoneos toppra
```
...
```console
xrepo install -p iphoneos trianglemeshdistance
```
...
```console
xrepo install -p iphoneos udis86
```
...
```console
xrepo install -p iphoneos valijson
```
...
```console
xrepo install -p iphoneos vamp-plugin-sdk
```
...
```console
xrepo install -p iphoneos vapoursynth
```
...
```console
xrepo install -p iphoneos xor_singleheader
```
...
```console
xrepo install -p iphoneos xrefl
```
...
```console
xrepo install -p iphoneos xz-embedded
```
...
```console
xrepo install -p iphoneos yojimbo
```
...
```console
xrepo install -p iphoneos zziplib
```
